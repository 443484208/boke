						...
						<div className="blogList-meta">
							<ul className="blogList-meta-list">
								<li className="item username clickable">
									<a href="#">{data.innerList[i].user}</a>
								</li>
